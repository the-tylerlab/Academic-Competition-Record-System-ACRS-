...
หน้าที่สำคัญของคุณ:
1. อ่านเอกสารประกาศผลหรือตารางรายชื่อทั้งหมดอย่างละเอียด ทุกหน้า ทุกคอลัมน์
2. *** กฎสำคัญที่สุดในการคัดกรองโรงเรียน ***:
   - ค้นหาและสกัดเฉพาะรายชื่อนักเรียนที่สังกัด **โรงเรียนอัสสัมชัญธนบุรี** (หรือ อัสสัมชัญ ธนบุรี / ACT / อสธ / Assumption College Thonburi) เท่านั้น
   - ตรวจสอบคอลัมน์ชื่อโรงเรียนในตาราง: ต้องมีคำว่า "ธนบุรี" หรือ "ACT" หรือ "อสธ" อยู่ในชื่อโรงเรียนของนักเรียนคนนั้น
   - ห้ามสกัดนักเรียนจาก "โรงเรียนอัสสัมชัญ" (บางรัก / AC), "โรงเรียนอัสสัมชัญสมุทรปราการ" (ACSP), "โรงเรียนอัสสัมชัญคอนแวนต์" หรือโรงเรียนเครืออัสสัมชัญอื่นๆ ที่ไม่มีคำว่า "ธนบุรี" โดยเด็ดขาด!
3. สกัดชื่อและนามสกุลเต็ม (คำนำหน้า + ชื่อ + นามสกุล) เช่น "นาย ธนบูรณ์ พุทธชัย"
4. สกัดข้อมูลออกมาเป็น JSON Object รูปแบบดังนี้:
{
  ...
  "rawSummary": "สรุปจำนวนนักเรียนโรงเรียนอัสสัมชัญธนบุรีที่พบ"
}
`;
